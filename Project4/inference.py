...
class ParticleFilter(InferenceModule):
    ...
    def observe(self, observation, gameState):
        ...
        if noisyDistance == None:
            ...
            for particle in beliefs:
                ...
                beliefs[particle] = beliefs[particle] * emissionModel[distance]

            if beliefs.totalCount() == 0.0:
                self.initializeUniformly(gameState)
            else:
                beliefs.normalize()
                self.particles = []
    ...
    def elapseTime(self, gameState):
        ...
        for particle in self.particles:
            updatedParticles.append(util.sample(self.getPositionDistribution(self.setGhostPosition(gameState, particle))))
